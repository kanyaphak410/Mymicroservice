...
public class ServeConfig {
	...
	@Bean
	public ProducerFactory<String,smsStatus> ServeProducerFactory() {
	...
	@Bean
	public KafkaTemplate<String,smsStatus> kafkaTemplateS() {
		return new KafkaTemplate<>(ServeProducerFactory());
	}
