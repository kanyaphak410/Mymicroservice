...
@Service 
public class DessertMessage {
	
    //private KafkaTemplate<String, String> kafkaTemplate;

	@Autowired
    private KafkaTemplate<String,smsStatus> kafkaTemplateSDS;

	@Autowired
    private KafkaTemplate<String,Stock> kafkaTemplateDS;
