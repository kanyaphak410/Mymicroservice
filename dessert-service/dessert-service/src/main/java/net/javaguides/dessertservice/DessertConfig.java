...
public class DessertConfig {
	@Bean
	public ConsumerFactory<String, Order> DessertconsumerFactory() {
	...
	//creating listener
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, Order> DessertListener(){
		ConcurrentKafkaListenerContainerFactory<String, Order> factory
		= new ConcurrentKafkaListenerContainerFactory<String, Order>();
		factory.setConsumerFactory(DessertconsumerFactory());
		return factory;
				
	}
	@Bean
	public ProducerFactory<String,smsStatus> DessertProducerFactory() {
	...
	@Bean
	public KafkaTemplate<String,smsStatus> kafkaTemplateSDS() {
		return new KafkaTemplate<>(DessertProducerFactory());
	}
	
	@Bean
	public ProducerFactory<String,Stock> stockDessertProducerFactory() {
		Map<String, Object> configProp = new HashMap<>();
		configProp.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "[::1]:9092");
		configProp.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
		configProp.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
	...
	@Bean
	public KafkaTemplate<String,Stock> kafkaTemplateDS() {
		return new KafkaTemplate<>(stockDessertProducerFactory());
	}
